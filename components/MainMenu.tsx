...
const DualCometBorder: React.FC<{ color: string; radius?: string; visible?: boolean; hoverable?: boolean }> = ({ color, radius = "1.8rem", visible = false, hoverable = true }) => (
...
const MainMenu: React.FC<MainMenuProps> = ({ onNavigate, totalReports, onGenerateMissionForCategory }) => {
    ...
    const handleInternalNavigate = (view: any, category?: Category, extra?: any) => {
        window.scrollTo({ top: 0, behavior: 'smooth' });
        onNavigate(view, category, extra);
    };

    const handleMissionNavigate = (cat: Category) => {
        window.scrollTo({ top: 0, behavior: 'smooth' });
        ...
        <div className="animate-fade-in max-w-[1400px] mx-auto px-4 pb-24 font-mono">
            <header className="mb-12 text-center flex flex-col items-center relative pt-8">
                ...
                <div className="relative z-10 space-y-8 flex flex-col items-center">
                    ...
                    <button 
                        type="button"
                        onClick={() => handleInternalNavigate('ecosystem')}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16 relative z-20">
                <PrimaryNavModule 
                    ...
                    status="READY"
                    colorClass="rose"
                    onClick={() => handleInternalNavigate('categorySelection')}
                />
                ...
                <PrimaryNavModule 
                    ...
                    status="LIVE_SYNC"
                    colorClass="emerald"
                    onClick={() => handleInternalNavigate('transparencyDatabase')}
                />
                ...
                <PrimaryNavModule 
                    ...
                    status="SECURE"
                    colorClass="cyan"
                    onClick={() => handleInternalNavigate('hub', undefined, 'my_reports')}
                />
                ...
                <PrimaryNavModule 
                    ...
                    status="ACTIVE"
                    colorClass="amber"
                    onClick={() => handleInternalNavigate('liveIntelligence')}
                />
                ...
                <PrimaryNavModule 
                    ...
                    status="SECURE"
                    colorClass="emerald"
                    onClick={() => handleInternalNavigate('heroHub', undefined, 'collection')}
                />
                ...
                <PrimaryNavModule 
                    ...
                    status="ACTIVE"
                    colorClass="amber"
                    onClick={() => handleInternalNavigate('heroHub', undefined, 'vault')}
                />
                ...
                <PrimaryNavModule 
                    ...
                    status="SYNCED"
                    colorClass="cyan"
                    onClick={() => handleInternalNavigate('heroHub', undefined, 'profile')}
                />
                ...
                <PrimaryNavModule 
                    ...
                    status="ALERT"
                    colorClass="rose"
                    onClick={() => handleInternalNavigate('outreachEscalation')}
                />
                ...
                <PrimaryNavModule 
                    ...
                    status="ACTIVE"
                    colorClass="amber"
                    onClick={() => handleInternalNavigate('heroHub', undefined, 'mint')}
                />
                ...
                <PrimaryNavModule 
                    ...
                    status="OPEN"
                    colorClass="emerald"
                    onClick={() => handleInternalNavigate('academy')}
                />
                ...
                <PrimaryNavModule 
                    ...
                    status="HEALTH"
                    colorClass="rose"
                    onClick={() => handleInternalNavigate('medicalOutpost')}
                />
                ...
                <PrimaryNavModule 
                    ...
                    status="SYNCED"
                    colorClass="cyan"
                    onClick={() => handleInternalNavigate('threatMap')}
                />
                ...
                <PrimaryNavModule 
                    ...
                    status="OVERSIGHT"
                    colorClass="purple"
                    onClick={() => handleInternalNavigate('aiRegulationHub')}
                />
                ...
                <PrimaryNavModule 
                    ...
                    status="LOGGING"
                    colorClass="blue"
                    onClick={() => handleInternalNavigate('hub', undefined, 'work_feed')}
                />
                ...
                <PrimaryNavModule 
                    ...
                    status="SUSTAIN"
                    colorClass="purple"
                    onClick={() => handleInternalNavigate('sustainmentCenter')}
                />
            </div>
                            ...
                            >
                                ...
                                {activeCategory === cat.value && (
                                    <div className="p-8 border-t border-zinc-800 animate-fade-in-fast flex flex-col gap-4 bg-zinc-950">
                                        <button
                                            type="button"
                                            onClick={() => handleInternalNavigate('reportSubmission', cat.value)}
                                        ...
                                        <button
                                            type="button"
                                            onClick={() => handleMissionNavigate(cat.value)}

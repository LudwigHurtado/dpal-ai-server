...
const ReedyRiverReportSchema = new Schema<IReedyRiverReport>(
  {
    ...
    sourceStatus: { type: [Schema.Types.Mixed], required: true, default: [] },
    findings: { type: [Schema.Types.Mixed], required: true, default: [] },
    actionIds: { type: [String], required: true, default: [] },
    projectRecommendations: { type: [Schema.Types.Mixed], required: true, default: [] },
